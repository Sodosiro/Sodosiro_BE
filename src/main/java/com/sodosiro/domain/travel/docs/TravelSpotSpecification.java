...
public interface TravelSpotSpecification {
    ...
    @Operation(
            ...
            description = "여행지 기본 정보, 좋아요 수, 리뷰 평균 평점, 리뷰 수, 인기 태그, 공통 ReviewResponse 형식의 최신 리뷰 최대 3건과 detailImage2 이미지 목록을 함께 반환합니다. 최신 리뷰에는 작성자·여행지·방문 유형·GPS 인증·내 리뷰 여부를 모두 포함합니다. "
